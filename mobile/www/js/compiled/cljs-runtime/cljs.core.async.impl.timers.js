...
var i_32632 = (0);
while(true){
if((i_32632 < arr.length)){
(arr[i_32632] = null);

var G__32633 = (i_32632 + (1));
i_32632 = G__32633;
continue;
} else {
}
...
var i_32642 = (self__.level + (1));
while(true){
if((i_32642 <= (new_level + (1)))){
(update[i_32642] = self__.header);

var G__32643 = (i_32642 + (1));
i_32642 = G__32643;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_32644 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32644[i]));
} else {
x__$2.forward.push((((i < links_32644.length))?(links_32644[i]):null));
}

if((i < links_32644.length)){
(links_32644[i] = x__$2);
} else {
links_32644.push(x__$2);
}
...
var i_32646 = (0);
while(true){
if((i_32646 <= self__.level)){
var links_32648 = (update[i_32646]).forward;
if((x__$1 === (((i_32646 < links_32648.length))?(links_32648[i_32646]):null))){
(links_32648[i_32646] = (x__$1.forward[i_32646]));

var G__32649 = (i_32646 + (1));
i_32646 = G__32649;
continue;
} else {
var G__32650 = (i_32646 + (1));
i_32646 = G__32650;
continue;
}
} else {
