...
}catch (e30362){var _e__27047__auto__ = e30362;
return false;
...
}catch (e30365){var _e__27047__auto__ = e30365;
return false;
...
}catch (e30367){var _e__27047__auto__ = e30367;
return false;
...
}catch (e30369){var _e__27047__auto__ = e30369;
return false;
...
}catch (e30371){var _e__27047__auto__ = e30371;
return false;
}})())){
...
}catch (e30373){var _e__27047__auto__ = e30373;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__30376 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30377 = (function (){var or__4223__auto__ = config;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30377);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30376);
}});
});
...
return (function() { 
var G__30478__delegate = function (args){
...
while (G__30479__i < G__30479__a.length) {G__30479__a[G__30479__i] = arguments[G__30479__i + 0]; ++G__30479__i;}
  args = new cljs.core.IndexedSeq(G__30479__a,0,null);
} 
return G__30478__delegate.call(this,args);};
...
return G__30478__delegate(args);
});
