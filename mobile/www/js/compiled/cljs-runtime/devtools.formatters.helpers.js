...
var G__28626 = devtools.prefs.pref(v);
v = G__28626;
continue;
} else {
return v;
...
}catch (e28581){var _e__27047__auto__ = e28581;
return false;
}})();
...
}catch (e28583){var _e__27047__auto__ = e28583;
return false;
}})();
...
}catch (e28585){var _e__27047__auto__ = e28585;
return false;
}}
}
});
...
var vec__28594 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28594,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28594,(1),null);
...
return cljs.core.some((function (p1__28601_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28601_SHARP_);
}),template);
});
