...
var len__4829__auto___28840 = arguments.length;
var i__4830__auto___28841 = (0);
while(true){
if((i__4830__auto___28841 < len__4829__auto___28840)){
args__4835__auto__.push((arguments[i__4830__auto___28841]));

var G__28842 = (i__4830__auto___28841 + (1));
i__4830__auto___28841 = G__28842;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28743){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28744,G__28745,seq28743__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28766_SHARP_){
return (!((cljs.core.meta(p1__28766_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28775__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28776){var _e__27047__auto__ = e28776;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e28783){var _e__27047__auto__ = e28783;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28790 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28791 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28791);

try{var map__28796 = opts;
var map__28796__$1 = cljs.core.__destructure_map(map__28796);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28796__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28790);
}});
...
var temp__5751__auto___28854 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___28854)){
var managed_print_level_28855 = temp__5751__auto___28854;
var _STAR_print_level_STAR__orig_val__28819_28856 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28820_28857 = managed_print_level_28855;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28820_28857);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28808_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28808_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28819_28856);
}} else {
job_fn();
}
