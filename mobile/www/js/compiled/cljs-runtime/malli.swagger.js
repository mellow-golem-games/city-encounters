...
var malli$swagger$SwaggerSchema$_accept$dyn_42290 = (function (this$,children,options){
var x__4521__auto__ = (((this$ == null))?null:this$);
var m__4522__auto__ = (malli.swagger._accept[goog.typeOf(x__4521__auto__)]);
...
var m__4519__auto__ = (malli.swagger._accept["_"]);
...
return malli$swagger$SwaggerSchema$_accept$dyn_42290(this$,children,options);
}
});

if((typeof malli !== 'undefined') && (typeof malli.swagger !== 'undefined') && (typeof malli.swagger.accept !== 'undefined')){
} else {
malli.swagger.accept = (function (){var method_table__4712__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__4713__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__4714__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4715__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4716__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("malli.swagger","default","malli.swagger/default",799472521)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__42269 = cljs.core.get_global_hierarchy;
...
return name;
}),new cljs.core.Keyword("malli.swagger","default","malli.swagger/default",799472521),hierarchy__4716__auto__,method_table__4712__auto__,prefer_table__4713__auto__,method_cache__4714__auto__,cached_hierarchy__4715__auto__));
})();
}
...
malli.swagger.accept.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"maybe","maybe",-314397560),(function (_,___$1,children,p__42274){
...
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42275__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var or__4223__auto__ = malli.json_schema.unlift(p,new cljs.core.Keyword(null,"swagger","swagger",-79684232));
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
var or__4223__auto____$1 = malli.json_schema.unlift(p,new cljs.core.Keyword(null,"json-schema","json-schema",389191695));
...
var G__42286 = malli.swagger._transform(_QMARK_schema,options__$1);
if(cljs.core.seq(cljs.core.deref(definitions))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__42286,new cljs.core.Keyword(null,"definitions","definitions",167529986),cljs.core.deref(definitions));
} else {
return G__42286;
}
}));
