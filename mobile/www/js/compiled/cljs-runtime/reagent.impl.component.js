...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38067 = c;
var G__38067__$1 = (((G__38067 == null))?null:G__38067.prototype);
if((G__38067__$1 == null)){
return null;
} else {
return G__38067__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38068 = c;
var G__38068__$1 = (((G__38068 == null))?null:G__38068.prototype);
if((G__38068__$1 == null)){
return null;
} else {
return G__38068__$1.render;
}
})() == null)))));
});
...
while (G__38157__i < G__38157__a.length) {G__38157__a[G__38157__i] = arguments[G__38157__i + 0]; ++G__38157__i;}
  args = new cljs.core.IndexedSeq(G__38157__a,0,null);
} 
...
var or__4223__auto__ = (function (){var G__38118 = c;
var G__38118__$1 = (((G__38118 == null))?null:G__38118.constructor);
if((G__38118__$1 == null)){
return null;
} else {
return G__38118__$1.displayName;
}
})();
...
var G__38128 = c;
var G__38128__$1 = (((G__38128 == null))?null:G__38128.constructor);
if((G__38128__$1 == null)){
return null;
} else {
return G__38128__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__38131 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38132 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38132);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38131);
}});
...
var c = this;
var G__38146_38162 = goog.object.get(c,"cljsRatom");
if((G__38146_38162 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38146_38162);
}
...
var renders_38163 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_38164 = cljs.core.first(cljs.core.vals(renders_38163));
...
if((cljs.core.count(renders_38163) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38163))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38164)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38164], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__38147 = o;
goog.object.set(G__38147,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__38148 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38149 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38149);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38148);
}});
...
var vec__38150 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38150,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38150,(1),null);
...
var G__38153 = goog.object.get(reagent_state,"cljsRatom");
if((G__38153 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__38153);
}
});
}),[]);
