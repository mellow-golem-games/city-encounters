...
var G__38185 = o;
goog.object.set(G__38185,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__38188 = o;
goog.object.set(G__38188,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__38192 = props;
var G__38192__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38192,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38192);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38192__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38193 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38193,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38193;
}
})(),id_class);
...
var G__38194 = (cljs.core.count(argv) - first_child);
switch (G__38194) {
case (0):
...
var vec__38195 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38195,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38195,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38195,(2),null);
...
var temp__5757__auto___38215 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___38215 == null)){
} else {
var key_38216 = temp__5757__auto___38215;
(jsprops.key = key_38216);
}
...
var temp__5757__auto___38217 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___38217 == null)){
} else {
var key_38218 = temp__5757__auto___38217;
(jsprops.key = key_38218);
}
...
var temp__5757__auto___38219 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___38219 == null)){
} else {
var key_38220 = temp__5757__auto___38219;
(jsprops.key = key_38220);
}
...
var temp__5757__auto___38221 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___38221 == null)){
} else {
var key_38222 = temp__5757__auto___38221;
(jsprops.key = key_38222);
}
...
var temp__5757__auto___38223 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___38223 == null)){
} else {
var key_38224 = temp__5757__auto___38223;
(jsprops.key = key_38224);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38198_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__38198_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__38199 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38199,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38199,(1),null);
...
break;
default:
var G__38230 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__38231 = compiler;
v = G__38230;
compiler = G__38231;
continue;
...
var G__38203 = tag;
var G__38203__$1 = (((G__38203 instanceof cljs.core.Keyword))?G__38203.fqn:null);
switch (G__38203__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template38205 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template38205 = (function (opts,id,fn_to_element,parse_fn,meta38206){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template38205.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38207,meta38206__$1){
var self__ = this;
var _38207__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38205(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta38206__$1));
}));

(reagent.impl.template.t_reagent$impl$template38205.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38207){
var self__ = this;
var _38207__$1 = this;
return self__.meta38206;
}));

(reagent.impl.template.t_reagent$impl$template38205.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38205.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38205.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template38205.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38205.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38205.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta38206","meta38206",366338041,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38205.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38205.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38205");

(reagent.impl.template.t_reagent$impl$template38205.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template38205");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38205.
 */
reagent.impl.template.__GT_t_reagent$impl$template38205 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template38205(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta38206){
return (new reagent.impl.template.t_reagent$impl$template38205(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta38206));
});

}

return (new reagent.impl.template.t_reagent$impl$template38205(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
